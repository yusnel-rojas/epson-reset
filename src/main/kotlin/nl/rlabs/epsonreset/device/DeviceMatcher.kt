...
object DeviceMatcher {
    ...
    data class Resolution(
        val model: nl.rlabs.epsonreset.db.PrinterModel?,
        val confidence: MatchedPrinter.Confidence,
        val candidates: List<nl.rlabs.epsonreset.db.PrinterModel> = emptyList(),
    ) {
        companion object {
    ...
    private fun exactOrClass(
        model: nl.rlabs.epsonreset.db.PrinterModel,
        raw: String,
        db: PrinterDatabase,
    ): Resolution {
