package nl.rlabs.epsonreset.debug
...
import nl.rlabs.epsonreset.net.Snmp
...
import nl.rlabs.epsonreset.protocol.FactoryReply
...
object NetworkProbe {
    ...
    private fun exchange(host: String, packet: ByteArray): ByteArray? {
        val command = nl.rlabs.epsonreset.protocol.EscpRemote.remoteCommandOf(packet) ?: return null
